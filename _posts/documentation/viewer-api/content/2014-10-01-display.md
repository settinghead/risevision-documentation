...
| **requestTicket**  |  **NO**  | [Request ticket](#{% post_url /documentation/viewer-api/notifications/2014-10-01-signals %}) received from the channel. |
...
`ping_interval` is the interval (in minutes) between [ping signals](#{% post_url /documentation/viewer-api/notifications/2014-10-01-signals %}) sent to the Viewer over the channel (default is 30).
